...
Tops = Frame(root,bg='black',bd=20,pady=5)
Tops.pack(side=TOP)
...
ReceiptCal_F = Frame(root,bg='black',bd=10)
ReceiptCal_F.pack(side=RIGHT)

Buttons_F=Frame(ReceiptCal_F,bg='black',bd=3)
Buttons_F.pack(side=BOTTOM)

Cal_F=Frame(ReceiptCal_F,bg='black',bd=6)
Cal_F.pack(side=TOP)

Receipt_F=Frame(ReceiptCal_F,bg='black',bd=4)
Receipt_F.pack(side=BOTTOM)

MenuFrame = Frame(root,bg='black',bd=10)
...
#########################################Drinks####################################################################
Sprite=Checkbutton(Drinks_F,fg='white',text='Sprite',variable=var1,onvalue=1,offvalue=0,font=('arial',18,'bold'),
                    bg='black',command=chkSprite).grid(row=0,sticky=W)
Pepsi=Checkbutton(Drinks_F,fg='white',text='Pepsi',variable=var2,onvalue=1,offvalue=0,font=('arial',18,'bold'),
                    bg='black',command=chkPepsi).grid(row=1,sticky=W)
DietCoke=Checkbutton(Drinks_F,fg='white',text='DietCoke',variable=var3,onvalue=1,offvalue=0,font=('arial',18,'bold'),
                    bg='black',command=chk_DietCoke).grid(row=2,sticky=W)
Mojito=Checkbutton(Drinks_F,fg='white',text='Mojito',variable=var4,onvalue=1,offvalue=0,font=('arial',18,'bold'),
                    bg='black',command=chk_Mojito).grid(row=3,sticky=W)
Cappuccino=Checkbutton(Drinks_F,fg='white',text='Cappuccino',variable=var5,onvalue=1,offvalue=0,font=('arial',18,'bold'),
                    bg='black',command=chk_Cappuccino).grid(row=4,sticky=W)
Fanta=Checkbutton(Drinks_F,fg='white',text='Fanta',variable=var6,onvalue=1,offvalue=0,font=('arial',18,'bold'),
                    bg='black',command=chk_Fanta).grid(row=5,sticky=W)
CocaCola=Checkbutton(Drinks_F,fg='white',text='CocaCola',variable=var7,onvalue=1,offvalue=0,font=('arial',18,'bold'),
                    bg='black',command=chk_CocaCola).grid(row=6,sticky=W)
ColdCoffee=Checkbutton(Drinks_F,fg='white',text='ColdCoffee',variable=var8,onvalue=1,offvalue=0,font=('arial',18,'bold'),
                    bg='black',command=chk_ColdCoffee).grid(row=7,sticky=W)
##############################################Drink Entry###############################################################
...
HotDog = Checkbutton(Food_F,fg='white',text="HotDog\t\t\t ",variable=var9,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='black',command=chk_HotDog).grid(row=0,sticky=W)
VegBurger = Checkbutton(Food_F,fg='white',text="VegBurger",variable=var10,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='black',command=chk_VegBurger).grid(row=1,sticky=W)
Pasta = Checkbutton(Food_F,fg='white',text="Pasta ",variable=var11,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='black',command=chk_Pasta).grid(row=2,sticky=W)
HamBurger = Checkbutton(Food_F,fg='white',text="Rice Plate ",variable=var12,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='black',command=chk_HamBurger).grid(row=3,sticky=W)
Sandwich = Checkbutton(Food_F,fg='white',text="Sandwich ",variable=var13,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='black',command=chk_Sandwich).grid(row=4,sticky=W)
Fires = Checkbutton(Food_F,fg='white',text="Fires ",variable=var14,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='black',command=chk_Fires).grid(row=5,sticky=W)
Spagetti = Checkbutton(Food_F,fg='white',text="Spagetti ",variable=var15,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='black',command=chk_Spagetti).grid(row=6,sticky=W)
Fazitas = Checkbutton(Food_F,fg='white',text="Fazitas ",variable=var16,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='black',command=chk_Fazitas).grid(row=7,sticky=W)
################################################Entry Box For Cake##########################################################
...
###########################################ToTal Cost################################################################################
lblCostofDrinks=Label(Cost_F,font=('arial',14,'bold'),text='Cost of Drinks\t',bg='black',
...
lblCostofFood=Label(Cost_F,font=('arial',14,'bold'),text='Cost of Foods  ',bg='black',
                fg='white',justify=CENTER)
...
lblServiceCharge=Label(Cost_F,font=('arial',14,'bold'),text='Service Charge',bg='black',
                fg='white',justify=CENTER)
...
lblPaidTax=Label(Cost_F,font=('arial',14,'bold'),text='\tPaid Tax',bg='black',bd=7
                ,fg='white',justify=CENTER)
...
lblSubTotal=Label(Cost_F,font=('arial',14,'bold'),text='\tSub Total',bg='black',bd=7
                ,fg='white',justify=CENTER)
...
lblTotalCost=Label(Cost_F,font=('arial',14,'bold'),text='\tTotal',bg='black',bd=7
                ,fg='white',justify=CENTER)
...
###########################################BUTTONS################################################################################
Total=Button(Buttons_F,padx=16,pady=1,bd=7,fg='white',font=('arial',16,'bold'),width=4,text='Total',
                        bg='black',command=CostofItem).grid(row=0,column=0)
Receipt=Button(Buttons_F,padx=16,pady=1,bd=7,fg='white',font=('arial',16,'bold'),width=4,text='Receipt',
                        bg='black',command=Receipt).grid(row=0,column=1)
Reset=Button(Buttons_F,padx=16,pady=1,bd=7,fg='white',font=('arial',16,'bold'),width=4,text='Reset',
                        bg='black',command=Reset).grid(row=0,column=2)
darkmode=Button(Buttons_F,padx=50,pady=1,bd=7,fg='white',font=('arial',16,'bold'),width=4,text='NORMAL MODE',
                        bg='black',command=darkmode).grid(row=1,column=1)
